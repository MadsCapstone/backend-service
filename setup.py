...
setup(
    ...
    license="MIT",
    # url="https://github.com/a-luna/flask-api-tutorial", changed this to where the package is located...
    # project_urls=PROJECT_URLS, # modify project urls for proper use
